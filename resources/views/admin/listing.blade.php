...
<h1 class="Title" >
      ...
      <div class="box">
            <div class="box-header with-border">
              <h3 class="box-title">
                <p>Importer un listing : </p>
                <button class="btn btn-block btn-success btn-xs" data-toggle="modal" data-target="#modal-client">Importer un nouveau listing</button>
              </h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table class="table table-bordered">
                ...
                <tr>
                  ...
                  <td>29/05/2018</td>
                  <td>31/05/2018</td>
                  <td><a href="list.html">Voir liste</a></td>
